...
public class ModelService {
            ...
            for (Player p : this.game.getPlayers()) {
                ...
                if (p.getMen().stream().noneMatch(
                    (m) -> (m.getPosition().getLeft() != null && m.getPosition().getLeft().getMan() == null) ||
                           ...
                           (m.getPosition().getBottom() != null && m.getPosition().getBottom().getMan() == null))) {
                    this.game.setWinner(p.getNext());
                }
            }
        }
    ...
    public void checkNextPhase() {
        ...
        // Change the phase from "placing" to "moving" and set the player action to moving, only if the current phase is really "placing"
    ...
    public void moveMan() {
        ...
        // Check that the game phase is "moving" and player action is "moving" or "flying"
        if (!(this.game.getPhase().equals(GAME_PHASE_MOVING) && (this.game.getCurrentPlayer().getAction().equals(PLAYER_ACTION_MOVING) || this.game.getCurrentPlayer().getAction().equals(PLAYER_ACTION_FLYING)))) {
            return;
        }
